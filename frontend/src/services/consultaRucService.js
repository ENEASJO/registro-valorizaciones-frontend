 ...
 */
export function validarFormatoRuc(ruc) {
 ...
 */
export function limpiarRuc(ruc) {
...
function transformarRespuestaAPI(apiData) {
    ...
    return {
        ...
        representantes_legales: representantes.map((rep) => ({
 ...
 */
function transformarDatosParaFormulario(datos) {
 ...
 */
function generarAdvertencias(datos) {
    const advertencias = [];
 ...
 */
export async function consultarRucAPI(ruc) {
 ...
 */
export async function consultarRucParaFormulario(ruc) {
 ...
 */
export async function verificarDisponibilidadAPI() {
    try {
        const controller = new AbortController();
 ...
 */
export function formatearRucParaMostrar(ruc) {
    const rucLimpio = limpiarRuc(ruc);
    if (rucLimpio.length === 11) {
 ...
 */
export function obtenerTipoContribuyente(ruc) {
    const rucLimpio = limpiarRuc(ruc);
    const prefijo = rucLimpio.substring(0, 2);
    const tipos = {
        '10': 'Persona Natural',
 ...
 */
export async function consultarRucConCache(ruc) {
    const rucLimpio = limpiarRuc(ruc);
