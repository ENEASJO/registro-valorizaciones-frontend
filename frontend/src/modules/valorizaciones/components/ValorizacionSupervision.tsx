...
const ValorizacionSupervision = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span>/</span>
          <span className="text-green-600">Valorización de Supervisión</span>
          <span>/</span>
          <span className="text-green-600 font-medium">Nueva Valorización</span>
        </div>
        
        <FormularioValorizacionSupervision 
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span className="text-green-600">Valorización de Supervisión</span>
          <span>/</span>
          <span className="text-green-600 font-medium">Detalle</span>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Valorización de Supervisión</h1>
        ...
        <button 
          ...
          className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg flex items-center gap-2 font-medium shadow-lg transition-all duration-200 hover:shadow-xl"
        >
      ...
      {/* Dashboard de métricas con tema verde */}
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        <div className="card bg-gradient-to-r from-green-50 to-green-100 border-green-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-green-600">Total Valorizado</p>
              <p className="text-2xl font-bold text-green-900">{estadisticasDashboard.totalValorizado}</p>
            </div>
        ...
        <div className="card bg-gradient-to-r from-emerald-50 to-emerald-100 border-emerald-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-emerald-600">Aprobadas</p>
              <p className="text-2xl font-bold text-emerald-900">{estadisticasDashboard.aprobadas}</p>
            </div>
        ...
        <div className="card bg-gradient-to-r from-teal-50 to-teal-100 border-teal-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-teal-600">Pagadas</p>
              <p className="text-2xl font-bold text-teal-900">{estadisticasDashboard.pagadas}</p>
            </div>
            <DollarSign className="w-8 h-8 text-teal-500 opacity-50" />
          </div>
        </div>
      </div>
      ...
      <div className="card">
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="text-green-600 hover:text-green-800 text-sm font-medium self-start"
          >
      ...
      <div className="card">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <button 
              onClick={abrirFormulario}
              className="mt-4 bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg flex items-center gap-2 mx-auto transition-colors"
            >
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {valorizacionesSupervision.map((val, index) => (
                  <motion.tr
                    key={val.id}
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      {'dias_atraso' in val && val.dias_atraso > 0 && (
