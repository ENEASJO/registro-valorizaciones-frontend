...
type TabActivo = 'ejecucion' | 'supervision';
type VistaActiva = 'lista' | 'crear-ejecucion' | 'crear-supervision' | 'detalle';
  ...
  if (vistaActiva === 'detalle' && valorizacionSeleccionada) {
    return (
      <DetalleValorizacion
        ...
        tipo={tabActivo === 'ejecucion' ? 'ejecucion' : 'supervision'}
        onBack={volverALista}
      />
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex gap-3">
          <button 
            onClick={abrirFormularioSupervision}
          ...
          <button 
            onClick={abrirFormularioEjecucion}
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8">
          <button
            onClick={() => setTabActivo('ejecucion')}
          ...
          >
            <div className="flex items-center gap-2">
              ...
              Valorizaciones de Ejecución
            </div>
          </button>
          <button
            onClick={() => setTabActivo('supervision')}
            className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div className="card bg-gradient-to-r from-orange-50 to-orange-100 border-orange-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-orange-600">Con Atraso</p>
              <p className="text-2xl font-bold text-orange-900">{estadisticasDashboard.conAtraso}</p>
            </div>
      ...
      <div className="card">
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="text-primary-600 hover:text-primary-800 text-sm font-medium self-start"
          >
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {valorizacionesActuales.map((val, index) => (
                  <motion.tr
                    key={val.id}
